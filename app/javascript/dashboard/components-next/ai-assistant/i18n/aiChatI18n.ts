...
const defaultStrings: Record<string, string> = {
  ...
  'AI_CHAT.INPUT.STOP': 'Stop generating',
  ...
  'AI_CHAT.SUGGESTIONS.LABEL': 'Try asking',
  'AI_CHAT.SUGGESTIONS.SUMMARIZE': 'Summarize this conversation',
  'AI_CHAT.SUGGESTIONS.DRAFT_REPLY': 'Draft a reply',
  'AI_CHAT.SUGGESTIONS.FIND_SIMILAR': 'Find similar conversations',
